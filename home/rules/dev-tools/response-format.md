...
## 3. Default Response Language

Unless the user explicitly asks for another language, respond in Korean. Technical terms and code identifiers may remain in their original form.

## 4. Plan Mode Output Language
